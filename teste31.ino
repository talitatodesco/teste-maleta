...
bool houveAtualizacao(uint8_t compartimento) {
  ...
  if (intervaloHoras[compartimento] != horarioInicialAnterior[compartimento]) {
    horarioInicialAnterior[compartimento] = intervaloHoras[compartimento];
    status = true;
  }
...
void AlarmTools() {
  ...
  switch (step) {
    ...
    case 1:
      ...
      Serial.println(horarioInicial[0]);
      Serial.println(minutoInicial[0]);

...
void AlarmTools() {
  ...
  switch (step) {
    ...
    case 1:
      tempoAtualCase0 = millis();
      Ch[0] = 5; //Firebase.getInt("maleta/C1/hora");
      Cm[0] = 3; //Firebase.getInt("maleta/C1/min");
      hora[0] = 0;//Firebase.getInt("maleta/C1/adhoramed");
      minuto[0] = 2; //Firebase.getInt("maleta/C1/adminmed");
